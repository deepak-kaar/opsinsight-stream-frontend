...
import { ManageFlagMappingComponent } from '../dialogs/manage-flag-mapping/manage-flag-mapping.component';
import { breakPointForToastComponent } from 'src/app/core/utils/breakpoint-utils';

@Component({
  selector: 'app-flag-mapping',
  standalone: false,
  templateUrl: './flag-mapping.component.html',
  styleUrl: './flag-mapping.component.css',
})
export class FlagMappingComponent implements OnInit, OnChanges {
  @Input() app: any;
  @Input() org: any;
  @Input() flagData: any;
 ...
 */
  ...
  createFlag() {
    this.ref = this.dialogService.open(ManageFlagMappingComponent, {
      modal: true,
      closable: true,
