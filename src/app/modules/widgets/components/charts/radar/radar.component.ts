...
export class RadarComponent extends BaseWidget {
  data: any;
  @Input() labels: any[] = [];
  @Input() values: any[] = [];
  @Input() title: any;
      ...
      datasets: [
        {
          ...
          pointBackgroundColor: this.style?.bgColor,
          pointBorderColor: this.style?.pBorderColor,
          pointHoverBackgroundColor: this.style?.phBgColor,
          pointHoverBorderColor: this.style?.phBorderColor,
          data: this.values,
        },
      ],
    };
